...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($slug) || empty($description) || empty($category)) {
        ...
        try {
            ...
            $check_stmt = $db->prepare("SELECT id FROM services WHERE slug = ? AND id != ?");
            $check_stmt->execute([$slug, $service_id]);
...
<head>
    ...
    <title>Edit Service - ConnectPro Admin</title>
...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="short_description" name="short_description" 
                                                  rows="3"><?php echo htmlspecialchars($service['short_description']); ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="features" name="features" 
                                                  rows="5"><?php echo htmlspecialchars($service['features']); ?></textarea>
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div id="image-preview" class="mt-2">
                                            <?php if ($service['image_url']): ?>
                                                <img src="<?php echo htmlspecialchars($service['image_url']); ?>" 
                                                     alt="Service Image" class="preview-image">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            <h6 class="card-title">Service Info</h6>
                                            <p class="card-text small mb-1">
                                                <strong>Created:</strong> <?php echo date('M j, Y g:i A', strtotime($service['created_at'])); ?>
                                            </p>
                                            <p class="card-text small mb-0">
                                                <strong>Updated:</strong> <?php echo date('M j, Y g:i A', strtotime($service['updated_at'])); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function previewImage(url) {
            ...
            if (url) {
                previewContainer.innerHTML = `<img src="${url}" alt="Service Image" class="preview-image">`;
            } else {
